 <?php
    ...
    $sql = $conn->query("UPDATE tbl_enquiry SET enquiry_person='$name',org_name='$orgname',mobile_no='$mobile',remarks='$remarks',file_name='$targetFilePath' WHERE enquiryid=$id;
  ");
    if ($sql) {
