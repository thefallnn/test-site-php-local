...
$result = mysqli_query($conn, "SELECT * FROM tbl_enquiry WHERE enquiryid = $id");
...
<body>
    ...
    <section class="ftco-section">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center" style="margin-top:-140px;">
                ...
                <form action="enquiry_update.php?id=<?php $id = $_GET['id'];
                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
                                    <div class="contact-wrap w-100 p-md-5 p-4">
                                        <h3 class="mb-4">Update Your Enquiry Details</h3>
                                        <div id="form-message-warning" class="mb-4"></div>
                                        <div id="form-message-success" class="mb-4">
                                            Your enquiry has been updated, thank you!
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="enquiry_person" id="enquiry_person" value="<?php echo $row['enquiry_person']; ?>">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="org_name" id="org_name" value="<?php echo $row['org_name']; ?>">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="mobile_no" id="mobile_no" value="<?php echo $row['mobile_no']; ?>">
                                                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#makeMeSummernote').summernote('code', '<p><?php echo $row['remarks']; ?></p>');
        });
    </script>
